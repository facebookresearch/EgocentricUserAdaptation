...
from continual_ego4d.metrics.metric import AvgMeterMetric, Metric, get_metric_tag, AvgMeterDictMetric
...
class OnlineLossMetric(AvgMeterMetric):
    ...
    @staticmethod
    def get_losses_from_preds(preds: list[Tensor], labels: Tensor, loss_fun):
