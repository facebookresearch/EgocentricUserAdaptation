...
class ContinualLabeledVideoDataset(torch.utils.data.IterableDataset):
    ...
    def __next__(self) -> dict:
        ...
        for i_try in range(self._MAX_CONSECUTIVE_FAILURES):
            ...
            print(f"nb_clips={len(clips)}, is_last_clip={is_last_clip},clip_start={clip_start},clip_end={clip_end}, video_len={video.duration} "
...
class UntrimmedClipSampler:
    ...
    def __call__(
        ...
        # logger.debug(f"Clip_info = {clip_info}, clip_info.clip_start_sec = {clip_info.clip_start_sec}"
        #              f"clip_info.clip_end_sec={clip_info.clip_end_sec}, clip_start_boundary={clip_start_boundary}")
        return ClipInfo(
