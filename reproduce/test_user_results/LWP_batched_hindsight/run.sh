...
#
# This script runs the labeled window predictor (LWP), operating per batch (batched).
# The hindsight performance predicts for the full stream using only the final batch in the stream.
...
grid_overwrite_args+=" MODEL.FREEZE_BACKBONE True"     # Don't freeze
