...
#OVERWRITE_CFG_ARGS+=" DATA_LOADER.NUM_WORKERS 6" # Super-low

OVERWRITE_CFG_ARGS+=" DATA.SHUFFLE_DS_ORDER False" # Only for manual shuffling, we have shuffled loader for offline iid training
OVERWRITE_CFG_ARGS+=" TRAIN.BATCH_SIZE 4" # For training head can take larger batch size
...
OVERWRITE_CFG_ARGS+=" MODEL.FREEZE_BACKBONE False"          # TRAIN FEATS
