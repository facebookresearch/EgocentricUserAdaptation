...
OVERWRITE_CFG_ARGS+=" DATA.PATH_TO_DATA_SPLIT_JSON.TRAIN_SPLIT '/fb-agios-acai-efs/mattdl/data/ego4d_lta_usersplits/2022-09-08_17-17-16_ego4d_LTA_usersplit/ego4d_LTA_train_usersplit_10users.json'"
OVERWRITE_CFG_ARGS+=" DATA.PATH_TO_DATA_SPLIT_JSON.TEST_SPLIT '/fb-agios-acai-efs/mattdl/data/ego4d_lta_usersplits/2022-09-08_17-17-16_ego4d_LTA_usersplit/ego4d_LTA_test_usersplit_40users.json'"
