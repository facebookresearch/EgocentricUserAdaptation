...
OUTPUT_DIR="./logs/${run_id}" # Alternative:/home/matthiasdelange/data/ego4d/continual_ego4d_pretrained_models_usersplit
mkdir -p "${OUTPUT_DIR}"
...
BACKBONE_WTS="/home/rxtan/ego4d_pretrained_models/pretrained_models/long_term_anticipation/kinetics_slowfast8x8.ckpt"
...
OVERWRITE_CFG_ARGS+=" DATA.PATH_TO_DATA_FILE ${EGO4D_ANNOTS}"
