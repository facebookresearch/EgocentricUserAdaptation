...
OVERWRITE_CFG_ARGS+=" GPU_IDS 4,5,6 NUM_USERS_PER_DEVICE 4" # 1,3,4,5,6
...
OVERWRITE_CFG_ARGS+=" CONTINUAL_EVAL.NUM_WORKERS 8 DATA_LOADER.NUM_WORKERS 4 PREDICT_PHASE.NUM_WORKERS 8 PREDICT_PHASE.BATCH_SIZE 30"
