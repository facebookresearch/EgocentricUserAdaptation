...
OVERWRITE_CFG_ARGS+=" GPU_IDS 1,2 NUM_USERS_PER_DEVICE 1" # 1,3,4,5,6
...
# IF RESUME:
OVERWRITE_CFG_ARGS+=" USER_SELECTION 68,421 GRID_RESUME_LATEST True" # Subset of users to process
