...
#exit
#-----------------------------------------------------------------------------------------------#
OVERWRITE_CFG_ARGS+=" DATA.RETURN_VIDEO False DATA_LOADER.NUM_WORKERS 4 TRAIN.BATCH_SIZE 4" # Workers per dataloader (i.e. per user process)
#OVERWRITE_CFG_ARGS+=" USER_SELECTION 104,108" # Subset of users to process
OVERWRITE_CFG_ARGS+=" GPU_IDS 7 NUM_USERS_PER_DEVICE 1"
