...
OVERWRITE_CFG_ARGS+=" GPU_IDS 0,2,3,4,5,7 NUM_USERS_PER_DEVICE 1 GRID_RESUME_LATEST True" # 1,3,4,5,6
...
OVERWRITE_CFG_ARGS+=" DATA_LOADER.NUM_WORKERS 10" # Super-low
...
BACKBONE_WTS="/home/matthiasdelange/sftp_remote_projects/ContextualOracle_Matthias/results/ego4d_action_recog/pretrain_slowfast_full_ego4d/logs/2022-10-10_17-04-38_UID09738eee-4f4a-4533-a51c-2652759b81ed/checkpoints/best_model.ckpt" # Use original Ego4d model to start with
# BEST_epoch=16-step=9383-val_action_loss=6.447.ckpt
...
OVERWRITE_CFG_ARGS+=" MODEL.FREEZE_MODEL True"          # Learn features as well
