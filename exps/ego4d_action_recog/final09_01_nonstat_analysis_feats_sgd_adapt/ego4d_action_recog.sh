...
#exit
#-----------------------------------------------------------------------------------------------#
OVERWRITE_CFG_ARGS+=" DATA_LOADER.NUM_WORKERS 3" # Workers per dataloader (i.e. per user process)
#OVERWRITE_CFG_ARGS+=" GPU_IDS 2 NUM_USERS_PER_DEVICE 10"
OVERWRITE_CFG_ARGS+=" GPU_IDS 2 NUM_USERS_PER_DEVICE 1"

# TODO tmp
#OVERWRITE_CFG_ARGS+=" FAST_DEV_RUN False FAST_DEV_DATA_CUTOFF 10 TRAIN.BATCH_SIZE 4" # DEBUG
